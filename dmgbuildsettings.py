...
#
# settings file for dmgbuild for azooKey.app, derived from https://dmgbuild.readthedocs.io/en/latest/example.html.
#
...
# The default argument is "/System/Applications/TextEdit.app". You can override by passing app=/path/to/My.app
...
icon_locations = {appname: (140, 120), "Input Methods": (500, 120)}
...
license = {
    ...
    "licenses": {
        ...
        "ja_JP": "This software is licensed under the terms of the MIT License."
    },
    "buttons": {
